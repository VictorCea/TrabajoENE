...
import static com.aiep.ene.domain.MenuAsserts.*;
...
class MenuResourceIT {
    ...
    private static final Integer DEFAULT_VALOR_PLATO = 1;
    private static final Integer UPDATED_VALOR_PLATO = 2;

    private static final String DEFAULT_DESCRIPCION_PLATO = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPCION_PLATO = "BBBBBBBBBB";
    ...
    public static Menu createEntity() {
        return new Menu().nombrePlato(DEFAULT_NOMBRE_PLATO).valorPlato(DEFAULT_VALOR_PLATO).descripcionPlato(DEFAULT_DESCRIPCION_PLATO);
    }
    ...
    public static Menu createUpdatedEntity() {
        return new Menu().nombrePlato(UPDATED_NOMBRE_PLATO).valorPlato(UPDATED_VALOR_PLATO).descripcionPlato(UPDATED_DESCRIPCION_PLATO);
    }
    ...
    void getAllMenus() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.[*].valorPlato").value(hasItem(DEFAULT_VALOR_PLATO)))
            .andExpect(jsonPath("$.[*].descripcionPlato").value(hasItem(DEFAULT_DESCRIPCION_PLATO)));
    }
    ...
    void getMenu() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.valorPlato").value(DEFAULT_VALOR_PLATO))
            .andExpect(jsonPath("$.descripcionPlato").value(DEFAULT_DESCRIPCION_PLATO));
    }
    ...
    void putExistingMenu() throws Exception {
        ...
        updatedMenu.nombrePlato(UPDATED_NOMBRE_PLATO).valorPlato(UPDATED_VALOR_PLATO).descripcionPlato(UPDATED_DESCRIPCION_PLATO);
    ...
    void partialUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.valorPlato(UPDATED_VALOR_PLATO).descripcionPlato(UPDATED_DESCRIPCION_PLATO);
    ...
    void fullUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.nombrePlato(UPDATED_NOMBRE_PLATO).valorPlato(UPDATED_VALOR_PLATO).descripcionPlato(UPDATED_DESCRIPCION_PLATO);
