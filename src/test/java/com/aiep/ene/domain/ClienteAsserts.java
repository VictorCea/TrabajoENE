...
public class ClienteAsserts {
    ...
    public static void assertClienteUpdatableFieldsEquals(Cliente expected, Cliente actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getMesa()).as("check mesa").isEqualTo(actual.getMesa()))
            .satisfies(e -> assertThat(e.getOrden()).as("check orden").isEqualTo(actual.getOrden()))
            .satisfies(e -> assertThat(e.getCantidadClientes()).as("check cantidadClientes").isEqualTo(actual.getCantidadClientes()));
    }
