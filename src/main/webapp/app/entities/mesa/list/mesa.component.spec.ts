...
import { sampleWithRequiredData } from '../mesa.test-samples';
...
describe('Mesa Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mesas()[0]).toEqual(expect.objectContaining({ id: 9830 }));
  });

  describe('trackId', () => {
    it('Should forward to mesaService', () => {
      const entity = { id: 9830 };
      jest.spyOn(service, 'getMesaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMesaIdentifier).toHaveBeenCalledWith(entity);
